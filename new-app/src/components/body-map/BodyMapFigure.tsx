...
const FRONT_VIEW: FigureView = {
  title: 'Front',
  silhouette:
    'M46 26c-7 0-13 3-18 8-6 6-9 15-10 26l-2 21c0 7 3 12 9 15l5 3 2 16-5 37c-1 8 4 14 12 14h4l4-46h6l4 46h4c8 0 13-6 12-14l-5-37 2-16 5-3c6-3 9-8 9-15l-2-21c-1-11-4-20-10-26-5-5-11-8-18-8Z',
  centerLine: 'M46 39v94',
  detailLines: ['M30 40c5 3 10 5 16 5s11-2 16-5', 'M33 95c4 5 8 8 13 8s9-3 13-8'],
  regions: [
    { id: 'shoulders', d: 'M23 38c4-7 11-11 23-11s19 4 23 11l-6 10c-4-3-10-5-17-5s-13 2-17 5Z' },
    { id: 'chest', d: 'M32 45c4-3 9-5 14-5s10 2 14 5l-4 18H36Z' },
    { id: 'biceps', d: 'M18 54c5 1 9 5 10 12l1 17h-8c-4-7-5-18-3-29Zm56 0c-5 1-9 5-10 12l-1 17h8c4-7 5-18 3-29Z' },
    { id: 'forearms', d: 'M21 83h8l-1 21h-9c-2-6-1-14 2-21Zm42 0h8c3 7 4 15 2 21h-9Z' },
    { id: 'core', d: 'M39 63h14l2 30H37Z' },
    { id: 'obliques', d: 'M31 61h8l-2 31h-8c-2-9-1-20 2-31Zm22 0h8c3 11 4 22 2 31h-8Z' },
    { id: 'hip_flexors', d: 'M38 94h8l-1 11h-9c0-4 1-8 2-11Zm8 0h8c1 3 2 7 2 11h-9Z' },
    { id: 'quadriceps', d: 'M33 106h11l-3 38H29c0-12 1-24 4-38Zm15 0h11c3 14 4 26 4 38H51Z' },
    { id: 'adductors', d: 'M43 106h6v38h-6Z' },
    { id: 'calves', d: 'M31 145h10l-3 26H29c-1-7 0-16 2-26Zm20 0h10c2 10 3 19 2 26h-9Z' },
  ],
}
...
const BACK_VIEW: FigureView = {
  ...
  silhouette:
    'M46 26c-7 0-13 3-18 8-6 6-9 15-10 26l-2 21c0 7 3 12 9 15l5 3 2 16-5 37c-1 8 4 14 12 14h4l4-46h6l4 46h4c8 0 13-6 12-14l-5-37 2-16 5-3c6-3 9-8 9-15l-2-21c-1-11-4-20-10-26-5-5-11-8-18-8Z',
  centerLine: 'M46 39v94',
  detailLines: ['M31 41c4 4 9 6 15 6s11-2 15-6', 'M35 94c3 4 7 7 11 7s8-3 11-7'],
  regions: [
    { id: 'shoulders', d: 'M23 38c4-7 11-11 23-11s19 4 23 11l-6 10c-4-3-10-5-17-5s-13 2-17 5Z' },
    { id: 'upper_back', d: 'M31 44c4-4 9-6 15-6s11 2 15 6l-4 17H35Z' },
    { id: 'lats', d: 'M27 48h8l-1 31h-8c-2-11-2-21 1-31Zm30 0h8c3 10 3 20 1 31h-8Z' },
    { id: 'triceps', d: 'M18 54c5 1 9 5 10 12l1 17h-8c-4-7-5-18-3-29Zm56 0c-5 1-9 5-10 12l-1 17h8c4-7 5-18 3-29Z' },
    { id: 'forearms', d: 'M21 83h8l-1 21h-9c-2-6-1-14 2-21Zm42 0h8c3 7 4 15 2 21h-9Z' },
    { id: 'lower_back', d: 'M38 66h16l3 22H35Z' },
    { id: 'glutes', d: 'M35 89c4-3 8-5 11-5s7 2 11 5l-3 17H38Z' },
    { id: 'hamstrings', d: 'M33 106h11l-3 38H29c0-12 1-24 4-38Zm15 0h11c3 14 4 26 4 38H51Z' },
    { id: 'adductors', d: 'M43 106h6v38h-6Z' },
    { id: 'calves', d: 'M31 145h10l-3 26H29c-1-7 0-16 2-26Zm20 0h10c2 10 3 19 2 26h-9Z' },
  ],
}
