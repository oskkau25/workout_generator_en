...
const FRONT_VIEW: FigureView = {
  ...
  detailLines: [
    'M30 40c5 3 10 5 16 5s11-2 16-5',
...
const BACK_VIEW: FigureView = {
  ...
  centerLine: 'M46 39v94',
  detailLines: [
    'M31 41c4 4 9 6 15 6s11-2 15-6',
    'M34 53c3 5 7 8 12 8s9-3 12-8',
  ...
  regions: [
    ...
    { id: 'triceps', d: 'M17 50c6 2 10 7 11 15l-1 21h-7c-3-8-4-23-3-36ZM75 50c-6 2-10 7-11 15l1 21h7c3-8 4-23 3-36Z' },
    { id: 'forearms', d: 'M21 83h8l-1 21h-9c-2-6-1-14 2-21ZM63 83h8c3 7 4 15 2 21h-9Z' },
